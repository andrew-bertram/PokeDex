...
function createPokeCard(pokemon) {
    ...
    // Setting the innerHTML for new card using the data/object that is passed into the "pokemon" parameter. Also, using toUpperCase method on the pokemon name so it will displau in UPPERCASE text.
    pokeCard.innerHTML = `
